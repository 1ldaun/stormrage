	...
	en: {
		translation: {
			htmlHead: {
				...
				content:
					"I'm Ildan Sharifullin, a 20-year-old Front-end developer. I like to create smart user interface and imagine useful interaction, developing rich web experiences & web applications and interest templates.",
			},
			header: {
				works: "Works",
				aboutMe: "About me",
	...
	ru: {
		translation: {
			htmlHead: {
				...
				content:
					"Здесь вы найдете мои работы в сфере фронтенд разработки, а также мои контакты. Ильдан Шарифуллин.",
			},
			header: {
				works: "Мои работы",
				aboutMe: "Инфо",
			...
			infoSection: {
				...
				aboutText:
					"Привет! Меня зовут Ильдан, мне 20 лет и я <strong>Фронтенд разработчик</strong>." +
				...
				skillsLetsTalkText:
					"Буду рад обсудить с тобой любые проекты/идеи, или просто поболтать за чашекой кофе 🖤",
			},
			worksSection: {
				title: "портфолио",
