	...
	return (
		...
		>
			<div
				className={cx(
					styles.rightBlock,
					isActive ? styles.rightBlock_active : "",
				)}
			>
				<div
				...
				{skillsList.map((skillItem) => (
					<>
						<h4
							key={skillItem.title}
							className={styles.rightBlock__subtitle}
						>
							{skillItem.title}
						</h4>
						<p
							key={skillItem.list}
							className={styles.rightBlock__text}
						>
							{skillItem.list}
						</p>
					</>
				...
				<h3 className={styles.rightBlock__title}>
					{t("infoSection.skillsLetsTalkSubtitle")}
				</h3>
				<p
					className={cx(
						styles.rightBlock__text,
						i18n.language === "ru"
							? styles.rightBlock__text_ruFont
							: "",
					)}
				>
					{t("infoSection.skillsLetsTalkText")}
				</p>
			...
			<div
				className={cx(
					styles.leftBlock,
					isActive ? styles.leftBlock_active : "",
					i18n.language === "ru" ? styles.leftBlock_ruFont : "",
				)}
			>
				<p className={styles.leftBlock__backgroundText}>About</p>
				<h3 className={styles.leftBlock__title}>
					{t("infoSection.aboutTitle")}
				</h3>
				<h4 className={styles.leftBlock__subtitle}>
					{t("infoSection.aboutSubtitle")}
				</h4>
				<p
					className={styles.leftBlock__content}
				...
				<ul className={styles.iconsList}>
					...
					<li className={styles.iconsList__item}>
						<div className={styles.iconsList__label}>
							Semicolons.
						</div>
						<JsImg />
					</li>
